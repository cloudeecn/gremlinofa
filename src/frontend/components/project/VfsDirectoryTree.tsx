...
import type { VfsAdapter, DirEntry } from '../../../shared/protocol/types/vfs';

// Phase 1.8 leak fix: inlined `getPathSegments` so the React layer
// doesn't import from `src/lib/vfsPaths` (which becomes backend-only).
// Paths from the VFS adapter are already normalized — strip leading slash
// then split on `/`, dropping any empty segments.
