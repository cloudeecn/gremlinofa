...
describe('effectiveInjectionMode', () => {
  ...
  it('keeps separate-block for all providers except webllm', () => {
  ...
  it('downgrades separate-block to inline for webllm', () => {
    expect(effectiveInjectionMode('separate-block', 'webllm')).toBe('inline');
  });
