/**
 * Context Swipe — selective message trimming for checkpoint-based context management.
 *
 ...
 * @param swipeToolNames - Tool names whose blocks should be removed
 ...
 * @returns New message array with context swipe applied
 */
export function applyContextSwipe(
  messages: Message<unknown>[],
  checkpointMessageId: string | undefined,
  swipeToolNames: Set<string> | undefined,
  modelFamily: APIType,
  ...
  const toolNames = swipeToolNames ?? new Set<string>();
