...
// Mock EncryptionCore — `dataImport.ts` constructs a temp core for the
// source CEK; the stub here lets the test short-circuit decryption.
...
describe('dataImport', () => {
  ...
  beforeEach(() => {
    ...
    // Mock EncryptionCore constructor to return our mock
