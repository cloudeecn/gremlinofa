 ...
 *
 * Uses real EncryptionCore for encryption/decryption.
 *
...
import { RemoteStorageAdapter } from '../../../worker/adapters/RemoteStorageAdapter';
...
describe('Cross-Adapter E2E Roundtrip', () => {
  ...
  let encryptionService: EncryptionCore;
  ...
  beforeAll(async () => {
    ...
    encryptionService = new EncryptionCore();
