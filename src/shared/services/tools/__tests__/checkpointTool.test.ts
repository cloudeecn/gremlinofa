...
import { ClientSideToolRegistry } from '../clientSideTools';
import type { ToolResult, ToolExecuteReturn } from '../../../protocol/types';
...
// Stubbed VFS adapter — checkpointTool's tests don't actually exercise
// adapter methods (the registry / executeToolSimple paths the tests cover
// don't reach into vfsAdapter.X), so an empty cast is enough to satisfy
// the ToolContext shape.
