...
// Build a vfs service against the in-memory storage + encryption stubs
// from `_vfsTestHelpers`. The test bodies destructure this once so the
// existing `createFile(...)`, `readFile(...)`, etc. references continue to
// work as standalone calls.
